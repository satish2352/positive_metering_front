...
function MyVerticallyCenteredModal(props) {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      let newData = {
        fullname, clg, mobile, dob, gender, fieldofstudy, username, password, comment
      }
        ...
        <Form onSubmit={handleSubmit}>
          <Row>
            ...
            <Col lg={6} md={6} sm={12}>
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                ...
                <Form.Control type="text" placeholder="collage name" value={clg} onChange={(e) => setclg(e.target.value)}/>
                {errors.clg && <span className="error text-danger">{errors.clg}</span>}
              </Form.Group>
            </Col>
          </Row>
          <Row>
            <Col lg={6} md={6} sm={12}>
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                ...
                <Form.Control type="tel" placeholder="enter number" value={mobile} onChange={(e) => setmobile(e.target.value)}/>
            ...
            <Col lg={6} md={6} sm={12}>
              <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                ...
                <Form.Control type="date" placeholder="collage name" value={dob} onChange={(e) => setdob(e.target.value)} />
          ...
          <Row>
            ...
            <Col lg={6} md={6} sm={12}>
              ...
              <Form.Select aria-label="Default select example" value={fieldofstudy} onChange={(e) => setfieldofstudy(e.target.value)}>
                <option>Open this select menu</option>
              ...
              {errors.fieldofstudy && <span className="error text-danger">{errors.fieldofstudy}</span>}
            </Col>
          </Row>
          <Row>
            <Col lg={6} md={6} sm={12}>
      ...
      <Container className='mt-3'>
        <Row>
          ...
          <Col lg={4} md={4} sm={12}>
            ...
            <Button variant="dark" id='getaquote_button' style={{ height: '45px', width: '200px', borderRadius: '60px' }} onClick={() => setModalShow(true)}>Get A Quote</Button>
