...
const ProductList = () => {
    ...
    const getNavLinkClass = (path) => {
        return currentPath === path ? 'text-decoration-none text-white fw-bold' : 'text-decoration-none text-white';
    };
                        ...
                        <Container className='produclistbox'>
                            <div className='py-3' id='menu'>
                                ...
                                {products.map((product, index) => (
                                    ...
                                    >
                                        <p className={` ${getNavLinkClass(`/Product/${product.id}`)} produclistcontetst ps-3 mx-3 pb-2`} style={{ fontFamily: 'Poppins' }}>
                                            {product.productName}
                                        </p>
                                    </div>
                                ))}
                        ...
                        <Col>
                            <Nav variant="pills" className="d-flex justify-content-center">
                                <Col lg={2} className="mx-2 mt-lg-0 mt-4">
                                    <Nav.Item>
                                        <Nav.Link eventKey="TECHNICAL" className="tabbuttons tabname text-center">
                                            TECHNICAL
                                        </Nav.Link>
                                    </Nav.Item>
                                </Col>
                                <Col lg={2} className="mx-2 mt-lg-0 mt-4">
                                    <Nav.Item>
                                        <Nav.Link eventKey="OPTION" className="tabbuttons tabname text-center">
                                            OPTION
                                        </Nav.Link>
                                    </Nav.Item>
                                </Col>
                                <Col lg={4} className="mx-2 mt-lg-0 mt-4">
                                    <Nav.Item>
                                        <Nav.Link eventKey="MATERIAL OF CONSTRUCTION" className="tabbuttons tabname text-center">
