                            ...
                            isChanged ?
                                <>
                                    <Col lg={{ span: 5, offset: 6 }}>
                                        <h2 className='text-white'>Vision <img style={{ width: "15%" }} src={visionEye}  alt="Vision_img" title='Vision_img' /> </h2>
                                        ...
                                        <h5 className='text-white'>Vision <img style={{ width: "50%" }} src={visionArrow} alt="Vision_img"  title="Vision_img" /> <span style={{ fontWeight: "200", }}> Mission </span> </h5>
                                    </Col>
                                    <Col xl={1}>
                                ...
                                <>
                                    <Col lg={{ span: 5, offset: 6 }}>
                                        <h2 className='text-white'>Mission <img style={{ width: "15%" }} src={visionEye} alt="Mission_img" title="Mission_img" /> </h2>
                                        <p className='text-white' style={{
                                            textAlign: "justify",
                                            fontSize: "0.78rem",
                                            fontWeight: "400"
                                        ...
                                        <h5 className='text-white'><span style={{ fontWeight: "200", }}> Vision </span> <img style={{ width: "50%" }} src={missionArrow} alt="Mission_img"  title='Mission_img'/> Mission </h5>
                                    </Col>
                                    <Col xl={1}>
                                        <IoIosArrowForward onClick={handleClick} style={{
                                            fontSize: "2.5rem",
