          ...
          {loading ? (
            ...
            <>
              <Col xs={4} lg={2} className="headercontact d-flex justify-content-evenly p-2 ps-lg-5">
                ...
                <a className='headerphone' href={`tel:${contacts[0]?.phone1}`} style={{ textDecoration: 'none' }}>{contacts[0]?.phone1}</a>
              </Col>
              <Col xs={4} md={1}></Col>
              <Col xs={4} lg={2} className="headercontact2 d-flex justify-content-evenly p-2 ps-lg-5">
                <FiPhone className='callicon' />
                <a className='headerphone' href={`tel:${contacts[0]?.phone2}`} style={{ textDecoration: 'none' }}>{contacts[0]?.phone2}</a>
              </Col>
            </>
          )}
        </Row>
